...
public class MarkHelpRequestUseCase {
    HelpRequestsRepository mHelpRequestsRepository;

    public MarkHelpRequestUseCase(HelpRequestsRepository helpRequestsRepository) {
        mHelpRequestsRepository = helpRequestsRepository;
    }
    public Observable<Response<ApiResponse>> execute(String token, int requestId) {
        return mHelpRequestsRepository.markHelpRequest(token,requestId);
    }
}
