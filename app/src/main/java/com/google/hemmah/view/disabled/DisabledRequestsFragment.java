...
public class DisabledRequestsFragment extends Fragment implements PopupMenu.OnMenuItemClickListener {
    private ArrayList<Post> mDisabledRequestPosts;
    ...
    private void intializeDisabledRequestsAdapter() {
        mDisabledRequestPosts = new ArrayList<>();
        mDisabledRequestPosts.add(new Post("I want help when going to the mosque", "Hi, my name is Hazem its good to see you,as you might know i have a visual impairment and i'am a muslim too so i need to pray 5 times a day so i need someone who lives near to me so that he can take me with him to the mosque every day my address provided below and thanks in advance", "25/1/2023","naser city"));
        mRecyclerView.setAdapter(new AppAdapter(mDisabledRequestPosts, R.layout.disabled_request_recycler_item, null));
